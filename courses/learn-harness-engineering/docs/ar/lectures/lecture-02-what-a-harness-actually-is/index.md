...
- استخدم "التحكم المتساوي للنموذج" لقياس المساهمة الحدية لكل نظام فرعي؛ واستخدم سجلات الفشل ونسب الأسباب لتحديد عنق الزجاجة الحقيقي.
