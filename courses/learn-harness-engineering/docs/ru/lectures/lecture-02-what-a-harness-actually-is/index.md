...
- Используйте «изометрический контроль модели», чтобы количественно оценить предельный вклад каждой подсистемы; используйте журналы сбоев и атрибуцию, чтобы найти настоящее бутылочное горлышко.
