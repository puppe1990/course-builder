...
export const readmeScreenshotTargets: ScreenshotTarget[] = [
  ...
  {
    language: "en",
    routePath: "/en/resources/",
    outputName: "en-resources.png",
  },
  ...
  {
    language: "zh",
    routePath: "/zh/resources/",
    outputName: "zh-resources.png",
  },
];
...
export async function discoverCoursePages(
  ...
  return files
    .filter((filePath) =>
      shouldIncludeInCoursePdf(
        path.relative(languageRoot, filePath).replace(/\\/g, "/"),
      ),
    )
